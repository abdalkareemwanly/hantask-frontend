...
export default function NewWord(props) {
    ...
    const addNewString = () => {
        ...
        axiosClient.post(`/admin/translation/update/${slug}`, translations).then(() => {
            getWords();
            closeForm();
        });
    }
            ...
            <div className="flex flex-col p-4">
                <div className="py-1 flex flex-col">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="String"
                        onChange={(ev) => { setTranslations({ ...translations , key : ev.target.value})}}
                    />
                </div>
                <div className="py-1 flex flex-col">
                    <label className="mb-2 text-secondary-text" htmlFor="">
                    ...
                    <input
                        ...
                        onChange={(ev) => { setTranslations({ ...translations, value: ev.target.value }) }}
                    />
                </div>
                <div className="flex flex-row justify-end gap-3 mt-3">
                    ...
                    <button className="border border-[lightgray] p-2"
