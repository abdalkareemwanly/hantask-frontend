...
export default function Chart() {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-around w-full mt-9 text-left">
      ...
      <div className="flex flex-col lg:flex-row md:flex-none  justify-around w-full mt-9 text-left">
        <div className="flex flex-col  p-5 text-inherit w-[100%] lg:w-[45%] component-shadow bg-blocks-color rounded-sm">
          <Bar data={data} options={options}></Bar>
        </div>
        <div className="flex flex-col  p-5 text-inherit w-[100%] lg:w-[45%] component-shadow bg-blocks-color rounded-sm">
