  ...
  return (
    <div className="flex justify-center items-center">
      <div className="group w-[230px] bg-white h-[320px] component-shadow flex flex-col items-center justify-center gap-6 rounded-xl border hover:border-greenColor transition-all">
        ...
        <Link to="/childcategories" state={{ currentSubcategory: { name: name, id: id } }} className="group-hover:bg-greenColor group-hover:text-white  border group-hover:border-transparent text-gray-400 px-8 py-2 rounded-md transition-all">
          show
        </Link>
      </div>
    </div>
